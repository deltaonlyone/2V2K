...
const PrivacyPolicy = () => {
    ...
    const handleToggleSignInBar = () => {
        const appRoot = document.getElementById('privacyPolicyContainer');
    ...
    return (
        <div className={`${styles['privacyPolicyPage']} ${currentTheme.backgroundColor}`}>
            ...
            <div id='privacyPolicyContainer'
                 className={`${styles['privacyPolicyContainer']} ${currentTheme.backgroundColor}`}>
                ...
                <div className={`${styles['containerDiv']} ${currentTheme.backgroundColor}`}>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        Website refers to Snavvy, accessible from http://localhost:3000/
                    </a>
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        ...
                        associated with that account.</a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        The Company may use Personal Data for the following purposes: </a>

                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        To provide and maintain our Service, including to monitor the usage of our Service. </a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        ...
                        including the security updates, when necessary or reasonable for their implementation. </a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        ...
                        about
                        unless You have opted not to receive such information. </a>

                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        To manage Your requests: To attend and manage Your requests to Us. </a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        ...
                        which
                        Personal Data held by Us about our Service users is among the assets transferred. </a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        ...
                        evaluate
                        and improve our Service, products, services, marketing and your experience. </a>

                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        We may share Your personal information in the following situations: </a>

                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        With Service Providers: We may share Your personal information with Service Providers to monitor
                        and
                        analyze the use of our Service, to contact You. </a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        ...
                        a
                        portion of Our business to another company. </a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        ...
                        certain products, services or promotions. </a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        ...
                        outside. If
                        You interact with other users or register through a Third-Party Social Media Service, Your
                        contacts
                        ...
                        with You and view Your profile. </a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        Protect and defend the rights or property of the Company </a>

                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        Prevent or investigate possible wrongdoing in connection with the Service </a>

                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                        Protect the personal safety of Users of the Service or the public </a>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    By email: snavvy_support@gmail.com
                    </a>
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    By phone number: +380630000000
                    </a>
