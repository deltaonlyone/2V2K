...
const TermsOfUse = () => {
    ...
    const handleToggleSignInBar = () => {
        const appRoot = document.getElementById('termsOfUseContainer');
    ...
    return (
        <div className={`${styles['termsOfUsePage']} ${currentTheme.backgroundColor}`}>

            {isOpenedSignIn &&
                <MenuSignIn handleToggleSign={handleToggleSignInBar} handleToggleSignUp={handleToggleSignUpBar}
                            handleToggleForgotPassword={handleToggleForgotPasswordBar}></MenuSignIn>}
            {isOpenedSignUp && <MenuSignUp handleToggleSignUp={handleToggleSignUpBar}
                                           handleToggleSign={handleToggleSignInBar}></MenuSignUp>}
            {isOpenedForgotPassword &&
                <MenuForgotPassword handleToggleForgotPassword={handleToggleForgotPasswordBar}></MenuForgotPassword>}

            <NavbarExpanded handleToggleSign={handleToggleSignInBar}></NavbarExpanded>

            <div id='termsOfUseContainer'
                 className={`${styles['termsOfUseContainer']} ${currentTheme.backgroundColor}`}>


                <div className={`${styles['containerDiv']} ${currentTheme.backgroundColor}`}>
                    <a className={`${styles['headerBig']} ${currentTheme.textColor}`}>
                        Website Terms of Use
                    </a>
                    <a className={`${styles['headerBig2']} ${currentTheme.textColor}`}>
                        Version 1.0
                    </a>
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    The Snavvy website located at http://localhost:3000/ is a copyrighted work belonging to Snavvy.
                    ...
                    USE THE SITE.
                    </a> <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    User Content. "User Content" means any and all information and content that a user submits to the
                    Site. You are exclusively responsible for your User Content. You bear all risks associated with use
                    of your User Content. You hereby certify that your User Content does not violate our Acceptable Use
                    ...
                    use the Site to collect, upload, transmit, display, or distribute any User Content (i) that violates
                    any third-party right or any intellectual property or proprietary right; (ii) that is unlawful,
                    ...
                    any loss or damage incurred as the result of any such interactions. If there is a dispute between
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    Cookies and Web Beacons. Like any other website, Snavvy uses ‘cookies'. These cookies are used to
                    ...
                    www.website.com and other sites on the internet. However, visitors may choose to decline the use of
                    ...
                    advertising partners are listed below. Each of our advertising partners has their own Privacy Policy
                    for their policies on user data. For easier access, we hyperlinked to their Privacy Policies below.
                    </a>
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    Google
                    </a>
                    ...
                    ukraine. After the Notice is received, you and the Company may attempt to resolve the claim or
                    dispute informally. If you and the Company do not resolve the claim or dispute within thirty (30)
                    ...
                    and unless the parties agree otherwise. If you reside outside of the U.S., the arbitrator shall give
                    ...
                    arbitrator grants you an award that is greater than the last settlement offer that the Company made
                    to you prior to the initiation of arbitration, the Company will pay you the greater of the award or
                    $2,500.00. Each party shall bear its own costs and disbursements arising out of the arbitration and
                    ...
                    law, the AAA Rules, and the Terms. The arbitrator shall issue a written award and statement of
                    ...
                    shall be resolved by arbitration under this Arbitration Agreement. Arbitration procedures are
                    typically more limited, more efficient and less expensive than rules applicable in a court and are
                    subject to very limited review by a court. In the event any litigation should arise between you and
                    the Company in any state or federal court in a suit to vacate or enforce an arbitration award or
                    ...
                    parties agree to maintain confidentiality unless otherwise required by law. This paragraph shall not
                    ...
                    ua County, California, for such purposes.
                    </a>
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    ...
                    as a waiver of such right or provision. The section titles in these Terms are for convenience only
                    and have no legal or contractual effect. The word "including" means "including without limitation".
                    If any provision of these Terms is held to be invalid or unenforceable, the other provisions of
                    these Terms will be unimpaired and the invalid or unenforceable provision will be deemed modified so
                    that it is valid and enforceable to the maximum extent permitted by law. Your relationship to
                    Company is that of an independent contractor, and neither party is an agent or partner of the other.
                    These Terms, and your rights and obligations herein, may not be assigned, subcontracted, delegated,
                    or otherwise transferred by you without Company's prior written consent, and any attempted
                    assignment, subcontract, delegation, or transfer in violation of the foregoing will be null and
                    void. Company may freely assign these Terms. The terms and conditions set forth in these Terms shall
                    be binding upon assignees.
                    </a>
                    <a className={`${styles['headerBig3']} ${currentTheme.textColor}`}>
                    ...
                    <a className={`${styles['textNormal']} ${currentTheme.textColorTransparency}`}>
                    Email: snavvy_support@gmail.com
                    </a>
