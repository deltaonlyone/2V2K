            ...
            <div className={`${styles['footerContainer']}`}>
                ...
                <div className = {`${styles['informationAboutUsSecond']}`}>
                    ...
                    <form className = {`${styles['formInformationInput']}`}>
                        <input placeholder="email address" type="text" name="text" className={`${styles['inputEmail']} ${currentTheme.inputEmailColor}`}></input>
                        <button className={`${styles['buttonSubmitEmail']} ${currentTheme.buttonSubmitEmailColor}`}>Submit</button>
                    </form>
                ...
                <div className = {`${styles['informationAboutUsThird']}`}>
                    ...
                    <div className = {`${styles['informationContacts']}`}>
                        <div className = {`${styles['informationContactsPhone']}`}>
                            <img className={`${styles['telephoneSvg']} ${currentTheme.svgColor}`} src={telephoneSvg} alt=""/>
